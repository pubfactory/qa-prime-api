...
////
////public class ArticleCitationPageTSCIR extends BaseTest{
////	private ArticleCitationPage articleCitationPage;
////	private MasterPage masterPage;
////
////	@Severity(SeverityLevel.BLOCKER)
////	@Test(groups = {"CitationGroup"},enabled = true,retryAnalyzer = Retry.class, description = "11 - Verify that the cite button available on current content page and  Preview/Export citation pop up will be displayed when clicked on it")
////	@Story("EPIC-971")
...
////		masterPage.clickOnCurrentArticleonHomePageTSCIRAPP();
...
////	
////	@Severity(SeverityLevel.BLOCKER)
////	@Test(groups = "Citation",enabled = true,retryAnalyzer = Retry.class, description = "12 - Verify that the 'X' link or cancel button on Preview/Export citation pop up are visible to user and it will be closed when user clicked anywhere outside the pop up or click on 'X' link or cancel button")
////	@Story("EPIC-971")
////	@Parameters({"testcaseid"})
...
////		
////	@Severity(SeverityLevel.BLOCKER)
////	@Test(groups = "Citation",enabled = true,retryAnalyzer = Retry.class, description = "13 - verify that the user able to select AMA and APA Citation format In Preview Export citation Popup For open access content")
////	@Story("EPIC-971")
////	@Parameters({"testcaseid"})
...
////	
////	@Severity(SeverityLevel.BLOCKER)
////	@Test(groups = {"Citation"},enabled = true,retryAnalyzer = Retry.class, description = "14 - Verify that the user able to see .RIS, .BIB, .ENW Export citation button and user Export the citations in .RIS, .BIB, .ENW format in appropriate folder location or default download folder  location")
////	@Story("EPIC-971")
////	@Parameters({"testcaseid"})
...
////	
////	@Severity(SeverityLevel.BLOCKER)
////	@Test(groups = "Citation",enabled = true,retryAnalyzer = Retry.class, description = "15 - verify The Export Citation Format Label on Citation Pop up")
////	@Story("EPIC-971")
////	@Parameters({"testcaseid"})
...
////	
////	@Severity(SeverityLevel.BLOCKER)
////	@Test(groups = "Citation",enabled = true,retryAnalyzer = Retry.class, description = "16 - verify The Abbreviated Journal Title Display On Export Citation Popup when AMA format seleted")
////	@Story("EPIC-971")
////	@Parameters({"testcaseid"})
...
//	}
//}
//>>>>>>> 543b2ad7cb6aa674d5dbf3399e303ea40bf4c831
