...
public class CopyPreviewCitationTest extends BaseTest {
    ...
    @Test(groups = {"CopyPreviewCitation"}, enabled = true, retryAnalyzer = Retry.class, description = "101  - Verify that User able to perform copy preview citation operation")
    @Story("EPIC-2789")
