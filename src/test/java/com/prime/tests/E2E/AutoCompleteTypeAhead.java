...
public class AutoCompleteTypeAhead extends BaseTest {
    ...
    public void verifythatTheAutoCompleteTypeAheadFunctionality() throws Exception {
        ...
        BaseTest.assertEquals(WebDriverManager.getDriver(), masterPage.VerifyingAutoSuggetionContainSearchWord(testData.get("searchkeyword").toString()), true,
        ...
        BaseTest.assertEquals(WebDriverManager.getDriver(), masterPage.getSearchBoxValue(), masterPage.getAllAutoSuggestionList().get(masterPage.getAllAutoSuggestionList().size() - 1),
        ...
        BaseTest.assertEquals(WebDriverManager.getDriver(), masterPage.getSearchBoxValue(), masterPage.getAllAutoSuggestionList().get(masterPage.getAllAutoSuggestionList().size() - 2),
