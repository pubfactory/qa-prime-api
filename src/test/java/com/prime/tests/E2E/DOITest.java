...
public class DOITest extends BaseTest{
    ...
    @Test(groups = {"Citation"}, enabled = true, retryAnalyzer = Retry.class,
            description = "88  - Verify that DOI meta data should be link")
    @Story("EPIC-1403")
    ...
    try {
            ...
            BaseTest.assertEquals(WebDriverManager.getDriver(),articleCitationPage.verifyDOIMetaDataIsLink(), true,"Verifying the DOI META data is Link or not ");
            ...
            BaseTest.assertEquals(WebDriverManager.getDriver(),"https://doi.org/"+DOIArticle, DOIAllen,"Verifying the DOI META data is Link or not ");
    }
    finally {
