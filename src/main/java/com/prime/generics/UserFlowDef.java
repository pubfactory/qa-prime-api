...
//	}
	...
	public void selectIssueDDAndVerifyCurrentIssueOnMostRecentVolumeList() throws Exception {
		...
		assertEqualsoftAssert(soft, driver, largestVolumeNumber, latestVolumeNum,
		...
		assertEqualsoftAssert(soft, driver, largestIssueNumber, latestIssueNum,
	...
	public void verifyEachListingHasTitleContributorDOIAndAbstractButton() throws Exception {
		...
		assertEqualsoftAssert(soft, driver, totalTitle, abstractButton,
	...
	public void verifyTheFirstArticleLoadsCorrectlyAndClickedLinkMatchesTitleOfLoadedArticle() throws Exception {
		...
		assertEqualsoftAssert(soft, driver, actualTitle, expectedTitle,
		...
		assertEqualsoftAssert(soft, driver, actualresult, "true",
	...
	public void verifyAllArticleAreFromTheIssueWhileNavigatingTheNextPrevControl() throws Exception {
		articleCitationPage = BasePage.initialize(WebDriverManager.getDriver(), ArticleCitationPage.class);
		assertEqualsoftAssert(soft, driver,
				articleCitationPage.verifyArticleAreFromTheIssueWhileNavigatingTheNextArticle(titleList), true,
				"Verifying all the Article are from The Issue while navigating the Next control.");

		assertEqualsoftAssert(soft, driver,
				articleCitationPage.verifyArticleAreFromTheIssueWhileNavigatingThePrevArticle(titleList), true,
	...
	public void verifyFulltextIsNavigableThroughArticleContent() throws Exception {
		...
		assertEqualsoftAssert(soft, driver, articleCitationPage.getTheAriaExpandedValueForarticleInformationTab(),
				"true", "Verifying user on article information tab.");
		articleCitationPage.clickOnResultsAticleContentLinkOnArticlePage();
		assertEqualsoftAssert(soft, driver, articleCitationPage.getTheAriaExpandedValueForFulltextTab(), "true",
	...
	public void verifyFigureOpenInPowePointOnceClicksOnItAndAbleToDownloadTheFigureInPPTFormatIfClicksOnDownloadButton()
		...
		try {
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyFiguresDiplayedInPPTFormat(), true,
					"verifying figures is diplayed in PPT format");
			articleCitationPage.clickOnNextButtonForSlidePPT();
			assertEqualsoftAssert(soft, driver, articleCitationPage.getTheSrcAttributeValueOfImageOrFigure(),
					url + "view/journals/anpr/67/2/full-i0003-3006-67-2-72-f02.png",
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.getTheSrcAttributeValueOfImageOrFigure(),
					url + "view/journals/anpr/67/2/full-i0003-3006-67-2-72-f01.png",
	...
	public void verifyCitationFunctionalityAndSelectEachFormatOfCitationAndCopyToClipBoardAndMakeSureItMatchesTheCitationPreview()
		...
		try {
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyCitationButtonPresentOnArticlePage(), true,
			...
			// button
			assertEqualsoftAssert(soft, driver, articleCitationPage.getPreviewExportCitationPopUpHeaderText(),
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.toVerifyCitationFormatFileIsDownload(".ris"), true,
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.toVerifyCitationFormatFileIsDownload(".bib"), true,
					"Verifying the file .ris format file is downloaded");

			deletedownloadedFiles(".bib");
			articleCitationPage.clickOnENWExportCitationFormat();

			assertEqualsoftAssert(soft, driver, articleCitationPage.toVerifyCitationFormatFileIsDownload(".enw"), true,
					"Verifying the file .ris format file is downloaded");
			...
			// popup
			assertEqualsoftAssert(soft, driver,
					articleCitationPage.verifyCopyToClipBoardButtonIsPresentOnPreviewExportCitationPopup(), true,
			...
			assertEqualsoftAssert(soft, driver,
					BaseTest.verifyStringContainsSpecificWord(abbreviatedTitleAPA, pastedAPAValued), true,
	...
	public void verifyShareButtonIsPresentAndEachOptionPromptsTheUSerToLogInInToTheRespectiveService()
		...
		try {
			...
			articleCitationPage = BasePage.initialize(WebDriverManager.getDriver(), ArticleCitationPage.class);
			assertEqualsoftAssert(soft, driver, articleCitationPage.getShareButtonTextOnArticlePage(), "Share",
					"Verifying the share button is present on article page");

			articleCitationPage.clickOnShareButtonOnArticlePage();

			assertTruesoftAssert(soft, driver,
					articleCitationPage.verifySharingPlatformDataNetworkUnderShareButton("facebook"),
			...
			Helper.INSTANCE.switchToWindowTab(1);
			assertTruesoftAssert(soft, driver, BaseTest.verifyTextInURL("facebook"),
					"Verifying if facebook window is opened");

			WebDriverManager.getDriver().close();
			Helper.INSTANCE.switchToWindowTab(0);

			assertTruesoftAssert(soft, driver,
					articleCitationPage.verifySharingPlatformDataNetworkUnderShareButton("linkedin"),
			...
			Helper.INSTANCE.switchToWindowTab(1);
			assertTruesoftAssert(soft, driver, BaseTest.verifyTextInURL("linkedin"),
					"Verifying if linkedin window is opened");
			WebDriverManager.getDriver().close();
			Helper.INSTANCE.switchToWindowTab(0);

			assertTruesoftAssert(soft, driver,
					articleCitationPage.verifySharingPlatformDataNetworkUnderShareButton("twitter"),
			...
			Helper.INSTANCE.switchToWindowTab(1);
			assertTruesoftAssert(soft, driver, BaseTest.verifyTextInURL("x.com"),
					"Verifying if twitter window is opened");
	...
	public void verifyPDFButonAvailableAndDownloadPDF() throws Exception {
		try {
			...
			assertEqualsoftAssert(soft, driver, pdfPage.verifyPDFButtonPresentOnArticlePage(), true,
			...
			assertEqualsoftAssert(soft, driver, pdfPage.verifyInlinePDFTabIsPresentOnArticlePage(), true,
			...
			// PDF Tab
			assertEqualsoftAssert(soft, driver, pdfPage.getDefaultPDFZoomValueInInlinePDFTab(),
					testData.get("defaultzoomvalue").toString(),
					"Verifying Default zoom value in Inline PDF Tab on article page");

			assertEqualsoftAssert(soft, driver, pdfPage.verifyZoomInButtonIsPresentInInlinePDFTabOnArticlePage(), true,
					"Verifying ZoomIn button is present on Inline PDF tab");

			assertEqualsoftAssert(soft, driver, pdfPage.verifyZoomOutButtonIsPresentInInlinePDFTabOnArticlePage(), true,
	...
	public void verifyGooglescholarAndPubmedSectionFunctionality() {
		try {
			driver.navigate().refresh();
			articleCitationPage = BasePage.initialize(WebDriverManager.getDriver(), ArticleCitationPage.class);
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyGoogleScholarButtonPresentOnArticlePage(),
					true, "Verifying the Google Scholar button is present at right hand side on Artical page");
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifySimilarArtcileHyperLinkPresentOnArticlePage(),
					true,
			...
			assertTruesoftAssert(soft, driver, BaseTest.verifyTextInURL("scholar"),
					"Verifying if google scholar tab is opened");
			...
			articleCitationPage = BasePage.initialize(WebDriverManager.getDriver(), ArticleCitationPage.class);
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyPubmedButtonPresentOnArticlePage(), true,
			...
			assertEqualsoftAssert(soft, driver, affiliationBlockAuthorPub.toString(), pubMedAuthor.toString(),
			...
			Helper.INSTANCE.switchToWindowTab(1);
			assertTruesoftAssert(soft, driver, BaseTest.verifyTextInURL(authorFirstNamePub),
	...
	public void verifyThatTheAutoLaunchNewEmailFunctionality() throws Exception {
		...
		assertEqualsoftAssert(soft, driver,
				articleCitationPage.verifyEmailAddressIsHyperLinkUnderArticleInformationTab(), true,
	...
	public void verifyContentMetaDataServiceInReferences() {
		try {
			...
			assertEqualsoftAssert(soft, driver, testData.get("searchpubmed").toString(),
			...
			Helper.INSTANCE.switchToWindowTab(1);
			assertTruesoftAssert(soft, driver, BaseTest.verifyTextInURL("pubmed"),
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyPubmedSiteIsLoaded(), true,
			...
			// on it.
			assertEqualsoftAssert(soft, driver, testData.get("searchgooglescholar").toString(),
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyGoogleScholarSiteIsLoaded(), true,
	...
	public void verifyThatDOIShouldBeLinkAndHandlingDOIRedirectFunctionality() throws Exception {
		try {
			...
			assertEqualsoftAssert(soft, driver, articleCitationPage.verifyDOIMetaDataIsLink(), true,
			...
			assertEqualsoftAssert(soft, driver, DOIArticle, DOIMainSite,
			...
			assertEqualsoftAssert(soft, driver, actualArticleTitlewithoutSlash, expectedArticleTitle,
			...
			assertEqualsoftAssert(soft, driver, actualArticleTitlewithSlash, expectedArticleTitle,
	...
	public void verifyThatTheCitationLinkFunctionalityIsWorkingFine() throws Exception {
		try {
			...
			assertEqualsoftAssert(soft, driver,
					articleCitationPage.verifyCitationsLinkIsPresentInGoofglrScholarSectionOnArticlePage(), true,
			...
			assertEqualsoftAssert(soft, driver, Helper.INSTANCE.verifyingNewTabIsOpen(), true,
			...
			// page.
			assertEqualsoftAssert(soft, driver, articlePageURL, googleScholarPageURL,
