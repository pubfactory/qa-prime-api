...
public class APIUtils {
	 ...
	 */
	public RequestSpecification requestSpecification(String baseURI, String endpoint, String platform, String site,
			String status)

	{
		System.out.println("INSIDE SPEC" + site + platform + status);
		RestAssured.baseURI = baseURI;
		req = new RequestSpecBuilder().setBaseUri(baseURI).addHeader("x-pf-internal", "true")
				.addPathParam("platform", platform).addPathParam("site", site).addPathParam("status", status)
