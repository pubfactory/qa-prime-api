...
public class TestListener implements IRetryAnalyzer, IExecutionListener, ITestListener, ISuiteListener {
    ...
    public void onExecutionFinish() {
        ...
        EmailReporter.reportBuilder(String.valueOf(TOTALTCCOUNT), String.valueOf(FAILTCCOUNT), String.valueOf(PASSTCCOUNT), String.valueOf(UNTESTEDTCCOUNT), timeCalculation);
        ...
        try {
            ...
            generator.ftlGenerator(String.valueOf(TOTALTCCOUNT), String.valueOf(FAILTCCOUNT), String.valueOf(PASSTCCOUNT), String.valueOf(UNTESTEDTCCOUNT), timeCalculation);
