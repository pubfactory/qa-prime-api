...
public class PDFPage extends BasePage {
	...
	public boolean verifyPDFButtonPresentOnArticlePage() throws Exception {
		List<WebElement> pdfbutton = driver
				.findElements(By.xpath("(//div[@data-testid='block-downloadpdfbutton']//child::a)[1]"));
	...
	public boolean verifyInlinePDFTabIsPresentOnArticlePage() throws Exception {
		...
		// driver.findElements(By.xpath("//button[contains(text(),'Inline PDF')]"));
		List<WebElement> element = driver
				.findElements(By.xpath("//button[text()='Full Text']//following::button[text()='PDF']"));
	...
	/**
	 * This method is used to check Zoom in button is present on Inline PDF tab on
	 * article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to check Zoom Out button is present on Inline PDF tab on
	 * article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method return default zoom value from PDFPageSize drop down from PDF
	 * viewer in Inline PDF tab on article page
	 * 
	 * @return String
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to clicks on the ZoomOut button from PDF viewer in Inline
	 * PDF tab on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @Created Date : 08/11/2023
	...
	/**
	 * This method is used to clicks on the ZoomOut button in PDF viewer in Inline
	 * PDF tab on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to check PDF page size changed after clicking on the zoom
	 * in button in PDF tab
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	...
	public boolean VerifyPDFSizeChangesWhenClickOnZoomInButtonAtHundredPercentZoom() throws Exception {
		// List<WebElement> element =
		// driver.findElements(By.xpath("(//div[@class='canvasWrapper'][contains(@style,'width:
		// 791px')])[1]"));
		WebElement element = driver
				.findElement(By.xpath("(//div[@class='canvasWrapper'][contains(@style,'width: 633px')])[1]"));
		scroll(element);
		List<WebElement> elements = driver
				.findElements(By.xpath("(//div[@class='canvasWrapper'][contains(@style,'width: 633px')])[1]"));
		return isElementPresent(elements);
	}

	/**
	 * This method is used to Select Default zoom value from PDFSizeChange drop down
	 * in PDF tab on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @Created Date : 08/11/2023
	...
	public boolean VerifyPDFSizeChangesWhenClickOnZoomOutButtonAtEightyPercentZoom() throws Exception {
		...
		// 633px')])[1]"));
		WebElement element = driver
				.findElement(By.xpath("(//div[@class='canvasWrapper'][contains(@style,'width: 475px')])[1]"));
		scroll(element);
		List<WebElement> elements = driver
				.findElements(By.xpath("(//div[@class='canvasWrapper'][contains(@style,'width: 475px')])[1]"));
		return isElementPresent(elements);
	}
	...
	/**
	 * This method return partial article title from PDF viewer in Inline PDF tab on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	public boolean verifyPDFButtonIsNotPresentOnRestrictedArticleOnArticlePage() throws Exception {
		List<WebElement> pdfbutton = driver
				.findElements(By.xpath("//div[@data-identifier='<toolbar>']//a[contains(text(),'Download PDF')]"));
	...
	/**
	 * This method is used to verify the watermark is presented on pdf in Pdf
	 * preview in Inline pdf tab on articla page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	...
	public boolean verifyWatermarkIsPresentOnPreviewInPDFTabOnArticlePage(String waterMarkAppsName) throws Exception {
		...
		List<WebElement> element = driver.findElements(
				By.xpath("(//span[@role='presentation' and contains(text(),'" + waterMarkAppsName + "')])"));
		return isElementPresent(element);
	}
	...
	public String getPartialArticleTitleFromInlinePDFTab(String text) throws Exception {
		WebElement partialText = driver
				.findElement(By.xpath("(//div[@class='textLayer'])[1]//span[contains(text(),'" + text + "')]"));
