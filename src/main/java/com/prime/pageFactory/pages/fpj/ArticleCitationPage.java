...
<<<<<<< HEAD
	...
	public boolean verifyCitationButtonPresentOnArticlePage() throws Exception {
		List<WebElement> cite = driver
				.findElements(By.xpath("(//a[contains(text(),'Get Permissions')])[1]//following-sibling::button"));
	...
	public boolean verifyPreviewExportCitationCloseButtonPresentOnPreviewExportCitationPopUp() throws Exception {
		List<WebElement> closebutton = driver.findElements(By.xpath(
				"//header[contains(text(),'Preview/Export Citation')]//following-sibling::button[@aria-label='Close']"));
...
//        String str1 = fileName.substring(0, 22);
		String citationFileName1 = citationFileName.substring((citationFileName.length()) - 4,
				citationFileName.length());
	...
	/**
	 * This method is used to check share via Email button is present on article
	 * page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method used to clicks email this content button on Share link popup on
	 * article page
	 *
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public void clickOnEmailThisContentButtonOnShareLinkOnArticlePage() throws Exception {
		clickOnElement(emailThisContentButton,
				"clicking on Email This content button on share Link popup on Article Page");
	}

	/**
	 * This method used to clicks on copy link button on Share link popupon article
	 * page
	 *
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to check popup close button is present on share link
	 * popup on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	...
	/**
	 * This method used to clicks on share link popup close button on Share link
	 * popup on article page
	 *
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public void clickOnShareLinkPopupClosekButtonOnShareLinkOnArticlePage() throws Exception {
		clickOnElement(shareLinkPopupCloseButton,
				"clicking on shareLink pop up close  button on share Link popup on Article Page");
	}

	/**
	 * This method is returns list of Author available on author affiliation block
	 * on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is returns list of Author available on Google scholar section on
	 * article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public List<String> getAllAuthorNamesFromAuthorGoogleScholarSectionOnArticlePage() throws Exception {
		List<String> authorsText = getTextFindElements(
				By.xpath("(//div[@data-testid='GoogleScholarWidget-container'])[1]//li//a"));
		return splitStringAndRetunsList(authorsText);
	}

	/**
	 * This method is returns list of Author available on PubMed section on article
	 * page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public List<String> getAllAuthorNamesFromPubMedSectionOnArticlePage() throws Exception {
		List<String> authorsText = getTextFindElements(
				By.xpath("(//div[@data-testid='PubMedWidget-container'])[1]//li//a"));
		return splitStringAndRetunsList(authorsText);

	}

	/**
	 * This method is used to check Altmetric Badge is present on right hand side on
	 * article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public boolean verifyAltmetricBadgePresentOnArticlePage() throws Exception {
		List<WebElement> altmtricBadge = driver
				.findElements(By.xpath("(//img[contains(@alt,'Article has an altmetric score')])[1]"));
		return isElementPresent(altmtricBadge);
	}

	/**
	 * This method is used to check Similar article hyperLink is present in google
	 * scholar section on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	...
	public boolean verifySimilarArtcileHyperLinkPresentOnArticlePage() throws Exception {
		List<WebElement> simlilarArticle = driver
				.findElements(By.xpath("(//a[text()='Similar articles in Google Scholar'])[1]"));
		return isElementPresent(simlilarArticle);
	}

	/**
	 * This method is used to check link copied message displayed on share link
	 * popup on article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public boolean verifyLinkCopiedSuccessfullyMessageDisplayedOnPopupOnArticlePage() throws Exception {
		// List<WebElement> linkCopiedMessage =
		// driver.findElements(By.xpath("//button[text()='Copy
	...
	/**
	 * This method is used to check Google Scholar is present on right hand side on
	 * article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to check PubMed is present on right hand side on article
	 * page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to click on Similar Article in Google Shcolar HyperLink
	 * in Google Shcolar section on Article Page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @Created Date : 03/11/2023
	...
	public void clickOnSimilarArticleInGoogleScholarHyperLink() throws Exception {
		clickOnElement(similarArticleInGoogleScolar,
				"Clicking on Similar Article in Google Shcolar HyperLink in Google Shcolar section on Article Page");
	}

	/**
	 * This method is used to check Article Element In Google scholar tab is
	 * presented When Click on Similar Article in Google Scholar HyperLink
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	 * @Created Date : 03/11/2023
	 */
	public boolean verifyArticleElementInGoogleScholarTabIsPresenstedWhenClickOnSimilarArticleInGoogleScholarHyperLink()
			throws Exception {
	...
	/**
	 * This method used to clicks on First Author in Google Scholar Section on
	 * Article Page
	 *
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is returns first Author available on Google scholar section on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	public String getFirstAuthorNamesFromGoogleScholarSectionOnArticlePage() throws Exception {
		WebElement authorsText = driver
				.findElement(By.xpath("((//div[@data-testid='GoogleScholarWidget-container'])[1]//li//a)[1]"));
		return splitStringandReturnString(getTextFromElement(authorsText));
	}

	/**
	 * This method is returns first Author available on pubMed section on article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	public String getFirstAuthorNamesFromPubMedSectionOnArticlePage() throws Exception {
		// WebElement authorsText =
		// driver.findElement(By.xpath("((//div[@data-testid='GoogleScholarWidget-container'])[1]//li//a)[1]"));
	...
	/**
	 * This method is used to checks Copy to ClipBoard button is present on preview
	 * Export Citation popup
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to checks Copy to ClipBoard button is present on preview
	 * Export Citation popup in headless ,ode
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	 ...
	 */
	public boolean verifyChakraToastMessageIsDisplayedAfterClickingOnCopyToClipBoardButtonInHeadless()
			throws Exception {
	...
	/**
	 * This method is used to checks the Selected citation format is displayed on
	 * chakra toast message
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	 * @return boolean
	...
	public boolean verifySelectedCitationFormatIsDisplayedInToastMessage(String formattype) throws Exception {
		List<WebElement> formatType = driver
				.findElements(By.xpath("//div[text()='" + formattype + " Preview Copied.']"));
	...
	/**
	 * This method used to Verify the Citations link is present in google scholar
	...
	/**
	 * This method is used to clicks on Citations link in google scholar section on
	 * article page
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to remove unwanted string from URL and return String
	 * format URL
	 * 
	 * @param s
	 * @return String
	...
	public String getBackgroundColor(String searchKeyword) {
		WebElement element = driver.findElement(By.xpath(
				"((//div[@class='abstract'])[1]//span[@class='hi' ][contains(text(),'" + searchKeyword + "')])[1]"));
	...
	/**
	 * This method return the Number of Citation text which is available on Article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method return the Number of Citation count which is available on Article
	 * page
	 * 
	 * @return int
	 * @throws Exception
	...
	/**
	 * This method is used to checks not provided ascending number before the each
	 * citation
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to checks the pagination style will be a string of
	 * numbers.
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public boolean verifyPaginationStyleWillBeAStringOfNumbersInCitedByOnArticlePage() throws Exception {
		List<WebElement> secondPagination = driver
				.findElements(By.xpath("(//li[contains(@data-testid,'pagination-page-index-2')])[1]"));
		return isElementPresent(secondPagination);
	}

	/**
	 * This method is used to click 2nd pagination link in Cited by element on
	 * article page.
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	public void clickOnSecondPaginationLinkInCitedByElementOnArticlePage() throws Exception {
		WebElement secondPagination = driver
				.findElement(By.xpath("((//span[text()='Page:'])[1]//following::li[text()='2'])[1]"));
		clickOnElement(secondPagination, "Clicking on second pagination link in cited by element on Article Page");
	}

	/**
	 * This method used to returns the total citation result in Cited By element On
	 * Article Page
	 * 
	 * @return int
	 * @throws Exception
	...
	/**
	 * This method used to checks the pagInation links is present in cited by
	 * element on article page
	 * 
	 * @return boolean
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method used to returns the pagInation number in Cited By element On
	 * Article Page
	 * 
	 * @return int
	 * @throws Exception
	...
	/**
	 * This method returns Default You are looking for text in Cited by element on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	public String getDefaultYouAreLookingForTextInCitedByElement() throws Exception {
		WebElement youAreLooking = driver
				.findElement(By.xpath("//p[text()='Publications Citing This Document']//following-sibling::p"));
		return getTextFromElement(youAreLooking);
	}

	/**
	 * This method returns the starting or ending result number of You are looking
	 * text in cited by element
	 * 
	 ...
	 * @Created Date : 18/06/2024
	 */
	public int getStartingAndEndingResultTextOfYouAreLookingInCitedByElement(int StartEndResultNumber)
			throws Exception {
	...
	/**
	 * This method is used to clicks rossRef link in Cited by element on article
	 * page.
	 * 
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method used to checks the DOI user to the citing article is present in a
	 * new browser tab after clicking on crossref link.
	 * 
	 * @return boolean
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method used to checks the pagInation in top of cited by element is
	 * present on article page.
	 * 
	 * @return boolean
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method used to checks the pagInation in bottom of cited by element is
	 * present on article page..
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the og:url meta tag content attribute value on article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method returns the og:type meta tag content attribute value on article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method returns the og:locale meta tag content attribute value on article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method returns the og:image meta tag content attribute value on article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method returns the og:title meta tag content attribute value on article
	 * page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check article author meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the article author meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check article publish meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	public boolean VerifyArticlePublishTimeMetaTagisPresentOnArticlePage() throws Exception {
		List<WebElement> articlePublishTime = driver
				.findElements(By.xpath("(//meta[@name='article:published_time'])[1]"));
		return isElementPresent(articlePublishTime);
	}

	/**
	 * This method returns the article publish meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check article section meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the article section meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation last page meta tag is present on
	 * article page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation last page meta tag content attribute value
	 * on article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation issue meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation issue meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation language meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation language meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation title meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation title meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation xml url meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation xml url meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation volume meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation volume meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation PDF URL meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation PDF URL meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation ISSN meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation ISSN meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation first page meta tag is present on
	 * article page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation first page meta tag content attribute value
	 * on article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation publisher meta tag is present on
	 * article page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation publisher meta tag content attribute value
	 * on article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation journal title meta tag is present on
	 * article page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	public boolean VerifyCitationJournalTitleMetaTagisPresentOnArticlePage() throws Exception {
		List<WebElement> citationJournalTite = driver
				.findElements(By.xpath("(//meta[@name='citation_journal_title'])[1]"));
		return isElementPresent(citationJournalTite);
	}

	/**
	 * This method returns the citation journal title meta tag content attribute
	 * value on article page
	 * 
	 * @return String
	 * @throws Exception
	 * @author Rakesh.Shevale
	...
	/**
	 * This method is used to check publication date meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	public boolean VerifyCitationPublicationDateMetaTagisPresentOnArticlePage() throws Exception {
		List<WebElement> citationPublicationDate = driver
				.findElements(By.xpath("(//meta[@name='citation_publication_date'])[1]"));
		return isElementPresent(citationPublicationDate);
	}

	/**
	 * This method returns the citation publication date meta tag content attribute
	 * value on article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check citation author meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation author meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method returns the citation DOI meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method returns the article tag meta tag content attribute value on
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to citation reference tag meta tag is present on article
	 * page
	 * 
	 * @return boolean
	 * @throws Exception
	...
	/**
	 * This method returns the citation reference meta tag content attribute value
	 * on article page
	 * 
	 * @return String
	 * @throws Exception
	...
	/**
	 * This method is used to check email element is present under Article
	...
	/**
	 * This method used to check the Email address is hyper link under Article
	 * Information Tab on article page
	 *
	 * @return boolean
	 * @author Rakesh.Shevale
	...
	public void clickOnEmailAddressUnderInformationTabOnArticlePage() throws Exception {
		clickOnElement(emailAddressUnderArticleInformationTab,
				"Clicking on the Email Address under Article Information tab on article page");
	}
	...
	/**
	 * This method returns the search pubmed text under references section on the
	 * article page
	 * 
	 * @return String
	 * @throws Exception
	...
	public void clickOnFirstSearchPubMedUnderReferecesSection() throws Exception {
		clickOnElement(searchPubMedUnderRef,
				"Clicking on the first search PubMed under Refereces on LHS on article page");
	}

	/**
	 * This method returns the search Google Scholar text under references section
	 * on the article page
	 * 
	 * @return String
	 * @throws Exception
	...
	public void clickOnFirstSearchGoogleScholarUnderReferecesSection() throws Exception {
		clickOnElement(searchGoogleScholarUnderRef,
				"Clicking on the first search Google Scholar under Refereces on LHS on article page");
	}
...
=======
     ...
     */
    public List<String> getAllAuthorNamesFromAuthorAffiliationBlockOnArticlePage() throws Exception {
        List<String> author = getTextFindElements(By.xpath("//div[contains(@data-testid,'block-contributors')]//button//span"));
        return author;
    }
     ...
     */
    public List<String> getAllAuthorNamesFromAuthorGoogleScholarSectionOnArticlePage() throws Exception {
        List<String> authorsText = getTextFindElements(By.xpath("(//div[contains(@data-testid,'block-googlescholarwidget')])[1]//li//a"));
        return splitStringAndRetunsList(authorsText);
    }
     ...
     */
    public List<String> getAllAuthorNamesFromPubMedSectionOnArticlePage() throws Exception {
        List<String> authorsText = getTextFindElements(By.xpath("(//div[contains(@data-testid,'block-pubmedwidget')])[1]//li//a"));
        return splitStringAndRetunsList(authorsText);
     ...
     */
    public String getFirstAuthorNamesFromGoogleScholarSectionOnArticlePage() throws Exception {
        WebElement authorsText = driver.findElement(By.xpath("((//div[@data-testid='block-googlescholarwidget'])[1]//li//a)[1]"));
        return splitStringandReturnString(getTextFromElement(authorsText));
    }
    ...
    public boolean verifyArticleAreFromTheIssueWhileNavigatingTheNextArticle(List<String> list) throws Exception {
        ...
        while (isNextButtonVisible) {
            try {
                WebElement nextButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[text()='NEXT'])[1]")));
                if (Helper.INSTANCE.VerifyListConainsSpecificString(list, getArticleHeaderOnArticlePage())) {
                    // System.out.println(count++ +" : " + getArticleHeaderOnArticlePage());
                    nextButton.click();
                    flag = true;
    ...
    public boolean verifyArticleAreFromTheIssueWhileNavigatingThePrevArticle(List<String> list) throws Exception {
        ...
        while (isNextButtonVisible) {
            try {
                WebElement nextButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[text()='PREV'])[1]")));
                if (Helper.INSTANCE.VerifyListConainsSpecificString(list, getArticleHeaderOnArticlePage())) {
                    // System.out.println(count++ +" : " + getArticleHeaderOnArticlePage());
                    nextButton.click();
                    flag = true;
    ...
    public boolean verifyAllFiguresAreLoadingInTheFigureTabOnArticlePage() {
        List<WebElement> images = driver.findElements(By.xpath("//img[contains(@alt,'Figure') and contains(@class,'chakra-image css')]"));
        boolean allImagesLoaded = false;
        for (WebElement image : images) {
            Long naturalWidth = (Long) ((JavascriptExecutor) driver).executeScript("return arguments[0].naturalWidth;", image);
            if (naturalWidth == 0) {
                allImagesLoaded = false;
            } else {
                allImagesLoaded = true;
    ...
    public boolean verifyFiguresDiplayedInPPTFormat() throws Exception {
        List<WebElement> images = driver.findElements(By.xpath("//div[@class='slick-slide slick-active slick-current']"));
        return isElementPresent(images);
    }
...
=======
    /**
     * This method used close Hypothesis View
     *
     *@param platformName
     * @throws Exception
     * @author Veena.Mathew
    ...
    @FindBy(xpath = "//button[text()='Copy link'][@aria-expanded='true']")
    private WebElement linkCopiedMessageDisplay;
    @FindBy(xpath = "((//div[@data-testid='block-googlescholarwidget'])[1]//li//a)[1]")
    private WebElement firstAuthorInGoogleSection;
    @FindBy(xpath = "(//div[contains(@data-testid,'block-pubmedwidget')])[1]//li//a")
    private WebElement firstAuthorInPubMedSection;
    @FindBy(xpath = "(//button[text()='Tools'])[1]")
    private WebElement toolsButtonInActionBar;
    @FindBy(xpath = "//a[@data-testid='Metadata-doi-link']")
