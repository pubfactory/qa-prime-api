...
public class BrowseOrSearchPage extends BasePage {
	...
	public String getFirstDOIValueOnBrowseOrSearchPage() throws Exception {
		WebElement firstDOIvalue = driver
				.findElement(By.xpath("(//span[contains(text(),'DOI')])[1]//following::span[1]"));
	...
	public void selectSortByValueSortByDropdownOnSearchOrBrowsePage(String value) throws Exception {
		selectByValue(sortByDropdown, value,
				"Selecting the value " + value + " from sort by dropdown on search or browse page");
	}
	...
	public void clickOnArticleTypeFilterValueOnBrowseOrSearchPage(String articleType) throws Exception {
		WebElement element = driver.findElement(
				By.xpath("//span[contains(text(),'By Article Type')]//following::ul[1]//li//button//span[text()='"
						+ articleType + "']"));
	 ...
	 * @Created Date : 27/09/2023
	 */
	public int getNumberOfFilteredResultsFrontOfArticleFilterValueOnBrowseOrSearchPage(String articleType)
			throws Exception {
		...
		String filterResult = getTextFromElement(driver.findElement(
				By.xpath("//span[contains(text(),'By Article Type')]//following::ul[1]//li//button//span[text()='"
						+ articleType + "']//following-sibling::span")));
	 ...
	 */
	public void selectRefineTermValueFromRefineTermDDOnBrowseOrSearchResultPage(String testidvalue,
			String refineTermOption) throws Exception {
		WebElement selectValueFromRefineTermDD = driver.findElement(
				By.xpath("//select[@data-testid='" + testidvalue + "']//option[text()='" + refineTermOption + "']"));
	...
	public List<String> getAllRefineTermValuesFromRefineTermDDOnBrowseOrSearchResultPage() throws Exception {
		List<String> filterValues = getTextFindElements(
				By.xpath("//select[@data-testid='AdvanceSearchFilter-select-0']//child::option"));
		return filterValues;
	}
	 ...
	 * @Created Date : 16/10/2023
	 */
	public void enterRefineTermValueInRefineTermBoxOnBrowseOrSearchPage(String testidvalue, String enterRefineTermValue)
			throws Exception {
		WebElement refineTermValueTxtBox = driver
				.findElement(By.xpath("//input[contains(@data-testid,'" + testidvalue + "')]"));
		typeOnElement(refineTermValueTxtBox, enterRefineTermValue,
				"Entering the Refine Term Value in Refine Term Textbox on Search or browse page");
	}
	...
	public boolean verifyRefineTermTextBoxIsPresentOnBrowseOrSearchPage(String testIDValue) throws Exception {
		List<WebElement> refineTermValueTxtBox = driver
				.findElements(By.xpath("//input[contains(@data-testid,'" + testIDValue + "')]"));
	...
	public boolean verifyRefineTermTextBoxIsNotPresentOnBrowseOrSearchPage(String testIDValue) throws Exception {
		List<WebElement> refineTermValueTxtBox = driver
				.findElements(By.xpath("//input[@data-testid='" + testIDValue + "']"));
	...
	public boolean verifyRefineTermValueOptionIsPresentOnBrowseOrSearchPage(String testidvalue) throws Exception {
		List<WebElement> selectValueFromRefineTermDD = driver
				.findElements(By.xpath("//select[@data-testid='" + testidvalue + "']"));
	 ...
	 * @Created Date : 06/10/2023
	 */
	public void clickOnCancelButtonFrontOfRefineTermTextBoxInRefineTermDDOnBrowseOrSearchPage(String testIDValue)
			throws Exception {
		WebElement refineTermTxtBoxCancelButton = driver
				.findElement(By.xpath("//button[contains(@data-testid,'" + testIDValue + "')]"));
		clickOnElement(refineTermTxtBoxCancelButton,
				"Clicking on Cancel button in front of Refine Term text box in Refine term DD on Browse or search page");
	}
	...
	public void clickOnRefineByTypeFilterValueOnBrowseOrSearchPage(String byType) throws Exception {
		WebElement element = driver.findElement(
				By.xpath("//span[contains(text(),'Refine by Type')]//following::ul[1]//li//button//span[text()='"
						+ byType + "']"));
	 ...
	 * @Created Date : 06/10/2023
	 */
	public void selectFromDateValueFromFromDateDDInRefineByDateFilterOnBrowseOrSearchResultPage(String value)
			throws Exception {
		selectByValue(selectDateFromDD, value, "Selecting the value " + value
				+ " from fromDate dropdown in refine by Date filter on Browse or Search Page");
	}
	 ...
	 * @Created Date : 06/10/2023
	 */
	public void selectFromDateValueFromToDateDDInRefineByDateFilterOnBrowseOrSearchResultPage(String value)
			throws Exception {
		selectByValue(selectDateToDD, value, "Selecting the value " + value
				+ " from toDate dropdown in refine by Date filter on Browse or Search Page");
	}
	...
	public void clickOnSubmitButtonInRefineByDateOnBrowseOrSearchPage() throws Exception {
		clickOnElement(submitBtnRefineByDate,
				"Clicking on Submit button in Refine By Date filter on Browse or search page");
	}
	...
	public void clickOnAccessTypeInRefineByAccessFilterOnBrowseOrSearchPage(String accessType) throws Exception {
		WebElement accessTypeEle = driver.findElement(By.xpath(
				"(//span[contains(text(),'Refine by Access')]//following::span[text()='" + accessType + "'])[1]"));
		clickOnElement(accessTypeEle, "Clicking on " + accessTypeEle
				+ " accesstype article in Refine By Access filter on Browse or search page");
	}
	 ...
	 * @Created Date : 10/10/2023
	 */
	public boolean VerifyfilterOptionInRefineByAccessFilterIsPresentOnBrowseOrSearchPage(String accessType)
			throws Exception {
		List<WebElement> accessTypeEle = driver.findElements(By.xpath(
				"(//span[contains(text(),'Refine by Access')]//following::span[text()='" + accessType + "'])[1]"));
	...
	public boolean verifyRefineTermFilterSearchKewordIsPresentOnSearchOrBrowsePage(String valueName) throws Exception {
		List<WebElement> SearchSlugSign = driver.findElements(
	 ...
	 * @Created Date : 18/10/2023
	 */
	public boolean verifyRefineTermFilterSearchKewordIsNotPresentOnSearchOrBrowsePage(String valueName)
			throws Exception {
		List<WebElement> SearchSlugSign = driver.findElements(
				By.xpath("//strong[text()='" + valueName + "']//parent::span//following-sibling::button"));
	 ...
	 * @Created Date : 10/10/2023
	 */
	public void clickOnSearchKeywordSearchSlugOrFilterValueSearchSlugOnBrowseOrSearchPage(String valueName)
			throws Exception {
	...
	public boolean verifyShareButtonIsPresentOnBrowseOrSearchPage() throws Exception {
		List<WebElement> share = driver
				.findElements(By.xpath("//span[@title='Share']//parent::button[@role='button']"));
	...
	public boolean verifySharingPlatformButtonIsPresentOnBrowseOrSearchPage(String platformName) throws Exception {
		List<WebElement> platform = driver
				.findElements(By.xpath("//button[contains(text(),'Share on " + platformName + "')]"));
	...
	public boolean verifyContentOnlinePublicationDateIsPresentOnBrosweOrSearchPage() throws Exception {
		List<WebElement> onlinepublication = driver
				.findElements(By.xpath("(//span[contains(text(),'Online Publication Date')])[1]"));
	...
	public boolean verifyContentAbstractIsPresentOnBrosweOrSearchPage() throws Exception {
		List<WebElement> abstractele = driver
				.findElements(By.xpath("((//div[@class='title'])[1]//following::span[text()='Abstract'])[1]"));
	...
	public String getBackgroundColor(String searchKeyword) {
		WebElement element = driver
				.findElement(By.xpath("(//span[@class='hi' ][contains(text(),'" + searchKeyword + "')])[1]"));
	...
	public void clickOnFirstJournalFilterValueFromByJournalFilterOnBrowseOrSearchPage() throws Exception {
		clickOnElement(firstJournalFilterValue,
				"Clicking on first journal filter value from By Journal filter On Browse or Search page");
	}
	...
	public String getFirstJournalAttributeValue() throws Exception {
		WebElement element = driver.findElement(By.xpath(
				"//span[text()='By Journal']//following::span[@data-testid='treeFilter']//following::button[1]"));
	...
	public boolean verifyAddValueIsPresentOnBrowseOrSearchPage() throws Exception {
		List<WebElement> AddValueField = driver
				.findElements(By.xpath("//button[contains(@data-testid,'AdvanceSearchFilter-add-new-value-0')]"));
	...
	public boolean verifySecondFilterboxIsPresentAfterClickingOnAddValue() throws Exception {
		List<WebElement> SecondFilterBox = driver
				.findElements(By.xpath("//input[contains(@data-testid,'AdvanceSearchFilter-input-0-1')]"));
	...
	public boolean verifyORtextIsPresentWithSecondFilterBox() throws Exception {
		List<WebElement> ORText = driver.findElements(By.xpath(
				"//input[contains(@data-testid,'AdvanceSearchFilter-input-0-1')]/parent::div/preceding-sibling::div[1]/p"));
	...
	public void clickOnCrossButtonOnAdvancedSearchFilterBrowseOrSearchPage(int itemRow) throws Exception {
		...
		clickOnElement(
				driver.findElement(By
						.xpath("//button[contains(@data-testid,'AdvanceSearchFilter-remove-cta-0-" + itemRow + "')]")),
	...
	public boolean verifySecondFilterboxForDateAfterClickingOnAddRow() throws Exception {
		List<WebElement> SecondFilterBox = driver
				.findElements(By.xpath("//button[contains(@data-testid,'dateSearchFilter-add-new-row')]"));
		return isElementPresent(SecondFilterBox);
	}
	...
	public boolean verifyAddRowbuttonIsAvailableForDateFilter() throws Exception {
		List<WebElement> addRow = driver
				.findElements(By.xpath("//span[@data-testid='dataFilter']//following::button[@title='[+] Add row']"));
	...
	public boolean verifyMultiDateFilterTermAvailableAfterclickOnAddRowButton(String rowNum) throws Exception {
		List<WebElement> secondRow = driver.findElements(By.xpath(
				"  //span[@data-testid='dataFilter']//following::button[@data-testid='dateSearchFilter-remove-cta-"
						+ rowNum + "']"));
	...
	public void clickOnCrossButtonForDateMultiTermFilter(String intRow) throws Exception {
		clickOnElement(driver.findElement(By
				.xpath("//span[@data-testid='dataFilter']//following::button[@data-testid='dateSearchFilter-remove-cta-"
						+ intRow + "']")),
	 ...
	 * @Created Date : 03/09/2024
	 */
	public void selectFromDateValueFromFromDateDDInRefineByDateFilterOnBrowseOrSearchResultPage(String rowNum,
			String value) throws Exception {
		WebElement selectDateFrom = driver.findElement(By.xpath(
				"(//span[contains(text(),'Refine by Date')]//following::select[@data-testid='dateSearchFilter-select-fromDate-"
						+ rowNum + "'])"));
		selectByValue(selectDateFrom, value, "Selecting the value " + value
				+ " from fromDate dropdown in refine by Date filter on Browse or Search Page");
	}
	 ...
	 * @Created Date : 03/09/2024
	 */
	public void selectFromDateValueFromToDateDDInRefineByDateFilterOnBrowseOrSearchResultPage(String rowNum,
			String value) throws Exception {
		WebElement selectDateTo = driver.findElement(By.xpath(
				"(//span[contains(text(),'Refine by Date')]//following::select[@data-testid='dateSearchFilter-select-toDate-"
						+ rowNum + "'])"));
		selectByValue(selectDateTo, value, "Selecting the value " + value
				+ " from toDate dropdown in refine by Date filter on Browse or Search Page");
	}
